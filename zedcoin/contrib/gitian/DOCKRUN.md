...
*Setup instructions for a Gitian build of Zedcoin using Docker.*
...
You'll also need to clone the zedcoin repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/zedcoin-project/zedcoin.git
cd zedcoin/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/zedcoin-project/gitian.sigs/) repo on your GitHub account.
