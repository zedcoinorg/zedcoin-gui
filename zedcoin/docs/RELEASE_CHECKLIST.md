...
- [ ] Code audit
- [ ] Ledger integration
  - [ ] Implemented in Zedcoin codebase (if needed)
  - [ ] Ledger app integration coded by Ledger
  - [ ] Ledger Zedcoin app update available
- [ ] Trezor integration
  - [ ] Implemented in Zedcoin codebase (if needed)
  - [ ] Trezor app integration coded by Trezor
  - [ ] Trezor firmware update available (if needed)
- [ ] Fork height set
  - [ ] Zedcoin-announce mailer notice
  - [ ] Twitter announcement
  - [ ] Reddit announcement
  - [ ] Getzedcoin.org announcement
- [ ] Notify wallets
  - [ ] MyZedcoin
  - [ ] Coinomi
  - [ ] Exa Wallet
  ...
  - [ ] ZEDWallet
- [ ] Notify exchanges
  - [ ] https://web.getzedcoin.org/community/merchants/#exchanges
- [ ] Notify 3rd party payment processors
  - [ ] https://web.getzedcoin.org/community/merchants/#payment-gateways
- [ ] Notify mining pools
  - [ ] https://miningpoolstats.stream/zedcoin
- [ ] Release tagged
  - [ ] Update src/version.cpp.in with new version AND new name (if necessary)
  - [ ] Update Gitian YML files in contrib/gitian/ to the new version number
  - [ ] Update README.md with new fork table entry (or at least update the Recommended Zedcoin version)
  ...
  - [ ] Update src/blocks/checkpoints.dat with ./zedcoin-blockchain-export --output-file checkpoints.dat --block-stop <recent block height> --blocksdat
...
- [ ] CLI released
  - [ ] https://web.getzedcoin.org/downloads/ updated
