# Zedcoin Blockchain Stats

Zedcoin Blockchain Stats utlity exports daily statistics for the zedcoin blockchain from creation through current state.

## Usage:

See also the utility's help option. `zedcoin-blockchain-stats --help`
...
- `zedcoin-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `zedcoin-blockchain-stats | save-to-database.sh`
