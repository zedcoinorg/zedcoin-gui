...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: ZedcoinComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: ZedcoinComponents.Style.blackTheme ? ZedcoinComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        ZedcoinComponents.ContextMenuItem {
