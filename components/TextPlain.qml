...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? ZedcoinComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    ZedcoinEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : ZedcoinComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : ZedcoinComponents.Style._w_defaultFontColor
    }
