...
TextArea {
    ...
    states: [
        State {
            name: "black";
            when: textArea.themeTransition && ZedcoinComponents.Style.blackTheme
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorBlackTheme ? textArea.colorBlackTheme : ZedcoinComponents.Style._b_defaultFontColor
                }
            }
        }, State {
            name: "white";
            ...
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorWhiteTheme ? textArea.colorWhiteTheme : ZedcoinComponents.Style._w_defaultFontColor
                }
            }
        }
    ]
