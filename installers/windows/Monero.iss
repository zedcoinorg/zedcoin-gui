; Zedcoin First Wallet GUI Wallet Installer for Windows
; Copyright (c) 2017-2024, The Zedcoin Project
; See LICENSE
#define GuiVersion GetFileVersion("bin\zedcoin-wallet-gui.exe")

[Setup]
AppName=Zedcoin GUI Wallet
...
DefaultDirName={commonpf}\Zedcoin GUI Wallet
DefaultGroupName=Zedcoin GUI Wallet
UninstallDisplayIcon={app}\zedcoin-wallet-gui.exe
...
LicenseFile=LICENSE
AppPublisher=The Zedcoin Developer Community
AppPublisherURL=https://zedcoin.org
TimeStampsInUTC=yes
...
; Background info:
; This installer indeed asks for admin rights so the Zedcoin files can be copied to a place where they have at least
...
; applications somehow. Luckily this is no issue here because ALL files are "private" to Zedcoin.

Source: {#file AddBackslash(SourcePath) + "ReadMe.htm"}; DestDir: "{app}"; DestName: "ReadMe.htm"; Flags: ignoreversion
Source: "FinishImage.bmp"; Flags: dontcopy
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion

; Zedcoin GUI wallet exe and guide
Source: "bin\zedcoin-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\zedcoin-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; Zedcoin CLI wallet
Source: "bin\extras\zedcoin-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; Zedcoin wallet RPC interface implementation
Source: "bin\extras\zedcoin-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion

; Zedcoin daemon
Source: "bin\zedcoind.exe"; DestDir: "{app}"; Flags: ignoreversion

; Zedcoin daemon wrapped in a batch file that stops before the text window closes, to see any error messages
Source: "zedcoin-daemon.bat"; DestDir: "{app}"; Flags: ignoreversion;

; Zedcoin blockchain utilities
Source: "bin\extras\zedcoin-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\zedcoin-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Filename: "{app}\zedcoin-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\zedcoin');
  s := 'The default folder to store the Zedcoin blockchain is ' + blockChainDefaultDir;
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\zedcoin-project\zedcoin-core', 'blockchainDataDir', blockChainDir);
  if blockChainDir = '' then begin
    blockChainDir := GetPreviousData('BlockChainDir', '');
  end;
  if blockChainDir = '' then begin
    // Unfortunately 'TInputDirWizardDirPage' does not allow empty field, so "propose" Zedcoin default location
...
begin
  Result := BlockChainDir('') + '\zedcoin.log';
...
begin
  if CurStep = ssPostInstall then begin
    // Re-build "zedcoin-daemon.bat" according to actual install and blockchain directory used
    SetArrayLength(s, 3);
    s[0] := 'REM Execute the Zedcoin daemon and then stay with window open after it exits';
    s[1] := '"' + ExpandConstant('{app}\zedcoind.exe') + '" ' + DaemonFlags('');
    s[2] := 'PAUSE';
    SaveStringsToFile(ExpandConstant('{app}\zedcoin-daemon.bat'), s, false); 
  end;
end;
...
[Icons]
; Icons in the "Zedcoin GUI Wallet" program group
; Windows will almost always display icons in alphabetical order, per level, so specify the text accordingly
Name: "{group}\GUI Wallet"; Filename: "{app}\zedcoin-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\zedcoin-gui-wallet-guide.pdf"; IconFilename: "{app}\zedcoin-wallet-gui.exe"
...
Name: "{group}\Utilities\Zedcoin Daemon"; Filename: "{app}\zedcoind.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\zedcoin-wallet-cli.exe"; WorkingDir: "{userdocs}\Zedcoin\wallets"
...
Name: "{group}\Utilities\x (Check Default Wallet Folder)"; Filename: "{win}\Explorer.exe"; Parameters: """{userdocs}\Zedcoin\wallets"""
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\zedcoin-wallet-gui\zedcoin-wallet-gui.log"""
Name: "{group}\Utilities\x (Try Daemon, Exit Confirm)"; Filename: "{app}\zedcoin-daemon.bat"
Name: "{group}\Utilities\x (Try GUI Wallet Low Graphics Mode)"; Filename: "{app}\start-low-graphics-mode.bat"
Name: "{group}\Utilities\x (Try Kill Daemon)"; Filename: "Taskkill.exe"; Parameters: "/IM zedcoind.exe /T /F"

; Desktop icons, optional with the help of the "Task" section
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\zedcoin-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\zedcoin-project"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\zedcoin-project\zedcoin-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\zedcoin-project\zedcoin-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};

; Configure a custom URI scheme: Links starting with "zedcoin:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily start payments; example URI: "zedcoin://<address>?tx_amount=5.0"
Root: HKCR; Subkey: "zedcoin"; ValueType: "string"; ValueData: "URL:Zedcoin Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "zedcoin"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "zedcoin\DefaultIcon"; ValueType: "string"; ValueData: "{app}\zedcoin-wallet-gui.exe,0"
Root: HKCR; Subkey: "zedcoin\shell\open\command"; ValueType: "string"; ValueData: """{app}\zedcoin-wallet-gui.exe"" ""%1"""

; Configure a custom URI scheme: Links starting with "zedcoinseed:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily hand over custom seed node info to the wallet, with an URI of the form "zedcoinseed://a.b.c.d:port"
Root: HKCR; Subkey: "zedcoinseed"; ValueType: "string"; ValueData: "URL:Zedcoin Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "zedcoinseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "zedcoinseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\zedcoin-wallet-gui.exe,0"
Root: HKCR; Subkey: "zedcoinseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\zedcoin-wallet-gui.exe"" ""%1"""
